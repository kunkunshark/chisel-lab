...
HD_PWD='C:/Users/Darryl Theodorus C/Documents/GitHub/chisel-lab/lab5/SevenSegDecoder/SevenSegDecoder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SevenSegDecoder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SevenSegDecoder.tcl -notrace
