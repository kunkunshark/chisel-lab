...
HD_PWD='C:/Users/Darryl Theodorus C/Documents/GitHub/chisel-lab/lab5/CountSevenSeg/CountSevenSeg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CountSevenSeg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CountSevenSeg.tcl -notrace
