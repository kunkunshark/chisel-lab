...
HD_PWD='C:/Users/Darryl Theodorus C/Documents/GitHub/chisel-lab/lab5/CountSevenSeg/CountSevenSeg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CountSevenSeg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CountSevenSeg.tcl
